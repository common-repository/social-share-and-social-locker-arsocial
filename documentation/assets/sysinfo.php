...
if ( is_plugin_active( 'arsocialshare/arsocialshare.php' ) ) 
{
  	$arsocial_active = "Active";
	$arsocial_version = get_option("arsocialshareversion");
	$upload_dir_path = wp_upload_dir();
}
else
{
	$arsocial_active = "Deactive";
	$arsocial_version = "";
	$upload_dir_path = wp_upload_dir();
}
...
<tr>
	<td colspan="2" class="title">ARSocial Details</td>
</tr>
<tr>
	<td class="leftrowtitle">Variable Name</td>
    <td class="rightrowtitle">Details</td>
...
<tr>
	<td class="leftrowdetails">ARSocial Status</td>
    <td class="rightrowdetails"><?php echo $arsocial_active;?></td>
</tr>
<tr>
	<td class="leftrowdetails">ARSocial Version</td>
    <td class="rightrowdetails"><?php echo $arsocial_version;?></td>
</tr>
<tr>
